...
var img = [
    ...
    "https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/blt302d7b76f5fdf7e3/602a79c908c7305a9aa62767/RiotX_ChampionList_fiddlesticks.jpg?quality=90&width=250",
...
for (i = 0; i < personagem.length; i = i + 1) {
    campeao.innerHTML +=
        `
      <tr>
          <td><h2>${personagem[i]}</h2></td>
          <td><img class="img" src="${img[i]}"></td>
      </tr>
        `
}
